...
namespace PomodoroTimerDesktopTests.Actions.TimerUpdate {
    [TestClass]
    public class CountdownTimerUpdateAction_HideSessionStartTests
    {
        ...
        public void ShouldAct()
        {
            ...
            CountdownTimerUpdateAction_HideSessionStart subject = new CountdownTimerUpdateAction_HideSessionStart(nextAction);
